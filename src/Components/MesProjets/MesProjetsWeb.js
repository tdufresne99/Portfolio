...
const MesProjetsWeb = ({projets}) => {
    return (
        <div className="mt-8">
            <p className='mb-16 text-green-700'>// Ce portfolio est une application React qui utilise une base de données pour intégrer dynamiquement le contenu des différentes sections.</p>
            <ul className="flex flex-wrap text-center justify-between">
                {
                    projets.map((unProjet,i) => {
                        console.log(unProjet.titre)
                        return (
